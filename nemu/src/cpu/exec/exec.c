...
make_group(group1_b,
	...
	inv, sub_i2rm_b, xor_i2rm_v, cmp_i2rm_b)
...
make_group(group1_sx_v,
	add_si2rm_v, or_i2rm_v, adc_si2rm_v, sbb_si2rm_v,
	inv, sub_si2rm_v, xor_i2rm_v, cmp_si2rm_v)
...
/* 0xf6 */
make_group(group3_b,
	test_i2rm_b, test_i2a_b, inv, neg_rm_b,
	mul_rm_b, imul_rm2a_b, div_rm_b, idiv_rm_b)

/* 0xf7 */
make_group(group3_v,
	test_i2rm_v, test_i2rm_v, inv, neg_rm_v,
...
/* 0xb4 */	inv, inv, movzx_rm2r_b, movzx_rm2r_b,
